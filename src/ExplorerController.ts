            ...
            <div id="emptyResults">
              <div class="columns col-gapless"><div class="column col-12">
                <div class="empty">
                  ...
                  <a id="shiftleft-scan-docs" href="https://docs.shiftleft.io/shiftleft/scan/scan">Shiftleft Scan Docs</a>
                  <div class="empty-results-animation">
                    <img src="${animatedGifPath}" alt="Matrix" />
                  </div>
                </div>
              </div></div>
            </div>

...
export class SarifClass {
    ...
    public static parseProperties(
        ...
        const returnObj = {
            props: new Array<SarifProperty>(),
            enums: new Array<SarifEnum>()
        };
        for (const propertyName in properties) {
            if (properties.hasOwnProperty(propertyName)) {
                if (propertyName !== "dependencies") {
                    const sarifProp = new SarifProperty(
                        propertyName,
     ...
     */
    public static markRequiredProps(
        properties: SarifProperty[],
        requiredProps: boolean | string[]
    ) {
     ...
     */
    public static getAdditionalPropertiesType(
        ...
        if (
            ...
            if (additionalProperties === true) {
                ...
                if (additionalProperties.type !== undefined) {
                    ...
                    type = SarifClass.upperCaseClassName(
    ...
    constructor(jsonClassName: string, jsonClass: JSONSchema4) {
        ...
        const propsAndEnums = SarifClass.parseProperties(
        ...
        this.additionalPropsType = SarifClass.getAdditionalPropertiesType(
            jsonClass.additionalProperties
        );
